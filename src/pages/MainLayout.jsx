    ...
    <div className="w-full min-h-screen bg-gray-50 mx-auto min-w-max">
      <div className="border-b p-2 flex items-center justify-around dark:bg-gray-950 dark:border-gray-500">
        ...
        <Link
          ...
          className="border p-2 rounded-md transition-all border-b-2 active:border cursor-pointer select-none dark:text-gray-300 dark:border-gray-500"
        >
          Submit your profile
        </Link>
        <Link to='https://mirac.lemonsqueezy.com/checkout/buy/584ed4e9-1325-4b28-962a-14e426535e7a' target='_blank' rel='noreferrer'>
          Buy Pre-Order
        </Link>
        <Tooltip id="tooltip" />
      </div>
